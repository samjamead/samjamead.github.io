    ...
    <div className="hero">
      <div className="container">
        ...
        <div className="intro-row">
          ...
          <div>
            <p>
              A developer's personal website is often just a place to hack
              around with new stuff, and this one is no exception! Here I'm
              playing with{" "}
          ...
          <div>
            <p>
              ...
              character count spot on, you are likely not alone. But hey, you
              know what? I think it does actually kind of work!
            </p>
          </div>
        </div>
      </div>
